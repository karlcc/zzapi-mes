...
CLASS zcl_zzapi_mes_handler IMPLEMENTATION.
  METHOD if_http_extension~handle_request.
    ...
    " Reuses existing ZMES001 structure and ZZ_CL_JSON serializer.
    " Produces identical JSON to the BSP page ZMES001.htm.
    ...
    CASE lv_method.
      WHEN 'GET'.
        " 3. Same SQL as BSP OnInitialization
